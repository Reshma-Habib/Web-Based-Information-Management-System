                ...
                <div class="sidemenu">
                    ...
                    <ul>
                        ...
                        <br>
                            ...
                            <span>Admission Form Upload</span>
                          </a> <br>
                          <a href="result.php">
                      <span><i class="fa fa-book"></i></span>
...
<div id="contact" class="container-fluid">
        <div class="cont" style="margin-left: 0%; width:100%; height: auto; background-color: #dfe4ea;border: 2px #c7ecee; margin-bottom: 20px;  float: left;  box-shadow: 0px 0px 12px 1px black;">
            ...
            <form enctype="multipart/form-data" method="post" style="text-align: justify; margin-left: 10%; margin-bottom: 10%;margin-right: 10%;">
